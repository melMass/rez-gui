...
from rezgui.Qt.QtWidgets import QLabel, QWidget, QTabWidget, QTableWidget, QAbstractItemView
...
class VariantHelpWidget(PackageLoadingWidget, ContextViewMixin):
    def __init__(self, context_model=None, parent=None):
        ...
        self.no_help_label = QLabel("No help found.")
